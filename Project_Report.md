...
**Techniques:** Deep Learning (SimpleRNN, LSTM), Time-Series Analysis, NLP Feature Engineering  
...
1. Feed the last 60 known days → predict day 1
2. Append prediction to the window, drop the oldest day
3. Feed the updated window → predict day 2
...
1. **Multivariate input:** Include all OHLCV columns + technical indicators as features
2. **Sentiment analysis:** Add Twitter/news sentiment scores as an additional input channel
3. **Alternative architectures:** Compare with GRU, Transformer (Temporal Fusion Transformer), or ARIMA/Prophet for benchmarking
4. **Larger window:** Try window sizes of 90 or 120 days
5. **Ensemble:** Average predictions from SimpleRNN + LSTM for more robust forecasts
...
|------------------------------------|--------------|
| Data collection and EDA            | Week 1, Day 1–2 |
| Data cleaning and preprocessing    | Week 1, Day 3   |
| SimpleRNN model training           | Week 1, Day 4   |
| LSTM model training                | Week 1, Day 5   |
| Hyperparameter tuning              | Week 2, Day 1   |
| Multi-step forecasting             | Week 2, Day 2   |
| Streamlit app development          | Week 2, Day 3–4 |
| Report writing                     | Week 2, Day 5   |
| Video recording                    | Week 3, Day 1   |
| **Final submission**               | **Jan 12, 2026** |

---

*Report prepared for the Tesla Stock Price Prediction deep learning project.*
